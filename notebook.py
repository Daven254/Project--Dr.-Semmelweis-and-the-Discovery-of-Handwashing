...
clinic_2.plot(x='year', y='proportion_deaths', label='clinic2', ax=ax)
...
ax = before_washing.plot(x = 'date' , y = 'proportion_deaths', label = "before summer 1847")
after_washing.plot(x = 'date' , y = 'proportion_deaths',ax=ax, label = "after summer 1847")
ax.set_ylabel('Proportion deaths')
plt.show()
